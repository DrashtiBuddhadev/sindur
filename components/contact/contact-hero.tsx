...
export function ContactHero() {
  return (
    <section className="relative overflow-hidden bg-[#12100d] px-6 pt-24 pb-16 md:px-12 md:pt-28 md:pb-20 lg:px-16 lg:pt-32">
      <span
        aria-hidden
        className="pointer-events-none absolute inset-x-0 top-[40%] block whitespace-nowrap text-center font-display text-[16vw] font-semibold leading-none text-white/5 select-none md:top-[44%]"
      >
        CONTACT
      </span>

      <Reveal className="relative z-10 mx-auto max-w-5xl text-center">
        <h1 className="whitespace-nowrap font-display text-3xl font-semibold leading-[1.15] text-white sm:text-4xl md:text-5xl lg:text-6xl">
          Connect With Sindur <span className="text-white/60">Group Now.</span>
        </h1>
      </Reveal>
